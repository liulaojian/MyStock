...
#define DEBUG_CATCH(s)		} catch (...) { ; }
#define DEBUG_CATCH2(s, x)	} catch (...) {   PrintfError("%s \n", x);}
#define	DEBUG_CATCH3(s, x, y)	} catch (...) {  PrintfError("%s %s \n", x,y); }
#define	DEBUG_CATCH4(s, x, y, z)	} catch (...) {  PrintfError("%s %s %s\n", x,y,z); }
#define	DEBUG_CATCH5(s, x, y, z, h)	} catch (...) {  PrintfError("%s %s %s %s \n", x,y,z,h); }
